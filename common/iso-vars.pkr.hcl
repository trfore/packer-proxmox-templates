...
variable "iso_url" {
  ...
  default = {
    ...
    "debian11" = "https://get.debian.org/images/archive/11.10.0/amd64/iso-cd/debian-11.10.0-amd64-netinst.iso"
    "debian12" = "https://cdimage.debian.org/debian-cd/current/amd64/iso-cd/debian-12.6.0-amd64-netinst.iso"
...
variable "iso_checksum" {
  ...
  default = {
    ...
    "debian11" = "file:https://get.debian.org/images/archive/11.10.0/amd64/iso-cd/SHA256SUMS"
